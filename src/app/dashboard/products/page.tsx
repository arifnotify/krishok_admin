...
export default function ProductsPage() {
    ...
    new Set(
      products.map((product) => {
        if (typeof product.category?.name === "object" && product.category?.name !== null) {
          return (product.category.name as { en?: string }).en || "";
        }
  ...
  const filteredProducts = products.filter((product) => {
    const matchesSearch =
      ...
      product.title.bn.toLowerCase().includes(search.toLowerCase());
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-5">
        ...
        <select
          className="w-full md:w-64 border p-3 rounded-xl bg-white"
              ...
              {filteredProducts.length === 0 ? (
                ...
                filteredProducts.map((product) => (
                  <tr key={product._id} className="border-t">
                    ...
                    {/* NAME */}
                    <td className="p-4">
                      <div className="font-medium">{product.title.en}</div>
                      <div className="text-gray-500">{product.title.bn}</div>
                    </td>
                      ...
                      {product.country ? (
                        <div className="flex items-center gap-3">
                          {product.country.flag ? (
                            ...
                            <div className="w-8 h-6 rounded bg-gray-100 flex items-center justify-center text-xs text-gray-400">
                              ?
                            </div>
                          )}
                          <div>
